...
1. `00_authority/PRINCIPLES.md` (non‑negotiable compass)
2. `00_authority/README.md`
3. `00_authority/PROJECT_INTENT.md`
4. `00_authority/MANIFEST.md`
5. `00_authority/REMlT_PARTNER_CURSOR.md` (goal framing + non-authoritative origin quotes)
